...
public class AudioCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = findViewById(R.id.audio_recyclerview);


        query = FirebaseDatabase.getInstance().getReference("Product").orderByChild("category").equalTo("Audio");
...
//                        Picasso.get().load(model.getImage()).into(holder.productImage);
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent = new Intent(AudioCategory.this, ProductDetails.class);
